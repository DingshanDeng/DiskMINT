...
file_parameters = os.path.join(working_dir, 'example_RULup_parameters')
#
...
#
para.write_parameters_to_csv(para.chemical_save_name+'_parameters', directory=working_dir, extension='.csv')
