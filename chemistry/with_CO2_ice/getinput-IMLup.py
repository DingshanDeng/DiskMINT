...
eta =  1.4*mp/rhobulk/ratio_g2d_total # here the g2d ratio total is estimated number
...
#
f = np.loadtxt(write_dir+fmodel_filename)
wl = f[:,0]
...
# f = np.loadtxt('../../COinitgrid-RULup-VHSE-fitlong-denser-Apr25-nr100-nz200-cyl.csv',skiprows=1,delimiter=',')
